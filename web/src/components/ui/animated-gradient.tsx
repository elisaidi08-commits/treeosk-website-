...
/**
 * AnimatedGradient — fond WebGL (shader) animé (21st.dev). Les presets d'origine sont néon ;
 * sur Treeosk on l'utilise via un `config` CUSTOM DÉSATURÉ (graphite/argent) pour rester premium.
 */
...
export function AnimatedGradient({
  ...
  const params = useMemo((): PresetParams => {
    ...
    const preset = presets[config.preset] || presets.Ghost;
