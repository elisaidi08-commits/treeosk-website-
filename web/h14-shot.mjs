...
await p.screenshot({path:`${base}/da-hero.png`});
await p.evaluate(()=>document.querySelector("#clients")?.scrollIntoView());
await p.waitForTimeout(1500); await p.screenshot({path:`${base}/da-clients.png`});
await p.evaluate(()=>document.querySelector("#contact")?.scrollIntoView());
await p.waitForTimeout(1400); await p.screenshot({path:`${base}/da-cta.png`});
